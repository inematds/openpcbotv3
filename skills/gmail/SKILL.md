...
allowed-tools: Bash(OPENPCBOT_DIR=* ~/.venv/bin/python3 ~/.config/gmail/gmail.py *)
---
...
The Gmail CLI reads credential paths from environment variables, loaded from OpenPCBot's `.env` via `OPENPCBOT_DIR`. Every command MUST use this prefix:
...
```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py list --all
```
...
```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py list --hours 48
```

### Read full email

```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py read <msg_id>
```

### Move email to label/folder

```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py move <msg_id> "Label Name"
```
...
```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py labels
```

### Reply to an email

```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py reply <msg_id> "Your reply body here"
```
...
```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py reply <msg_id> "Your reply body here" --attachments "/path/to/file1.pdf,/path/to/file2.png"
```

### Send a new email

```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py send "to@example.com" "Subject here" "Body here"
```

### Send with attachments

```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py send "to@example.com" "Subject" "Body" --attachments "/path/to/file.pdf,/path/to/other.xlsx"
```

### Create a Gmail filter (auto-sort rule)

```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py filter --from "sender@example.com" --label "LabelName" --archive --read
```
...
```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py filters
```

### Re-authenticate

```bash
OPENPCBOT_DIR=/path/to/openpcbot ~/.venv/bin/python3 ~/.config/gmail/gmail.py auth
```
