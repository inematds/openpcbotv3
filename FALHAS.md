...
| 2026-09-07 | ingestão de agenda ficaria cega a eventos novos: o marcador guardava o `start` do evento mais distante da janela, e todo compromisso criado depois tinha data menor | usar o instante da leitura como id da janela (dedupe por hash absorve o reprocesso) | prompt |
